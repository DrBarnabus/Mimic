...
/// <summary>
/// Defines the setup interface for configuring expectations on methods that return values of type <typeparamref name="TResult"/>.
/// This interface provides the entry point for setting up method call expectations and configuring return behaviors.
/// </summary>
/// <typeparam name="TMimic">The type of the mimic object being configured.</typeparam>
/// <typeparam name="TResult">The type of value returned by the method being configured.</typeparam>
/// <remarks>
...
/// <list type="bullet">
/// <item><description><see cref="ICallback{TResult}"/> - For defining callback actions with access to the return value</description></item>
/// <item><description><see cref="IReturns{TResult}"/> - For configuring what value the method should return</description></item>
...
/// </list>
/// This interface is typically used when setting up expectations for methods, properties, or indexers
/// that return values, allowing you to define both the return behavior and additional actions.
/// </remarks>
[PublicAPI]
    ...
    where TMimic : class
{
    ...
    /// </summary>
    /// <returns>
    /// A <see cref="ISequenceSetup{TResult}"/> instance that allows configuring behaviors to be executed
    /// in sequence for consecutive method calls, with support for different return values.
    /// </returns>
    /// <remarks>
    /// Sequential setups are useful when you need different return values or behaviors for consecutive calls
    /// to the same method. Each call to the method will advance to the next configured behavior in the sequence.
