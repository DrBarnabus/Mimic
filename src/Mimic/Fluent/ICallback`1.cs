...
/// <summary>
/// Provides callback functionality for mock setups that return values of type <typeparamref name="TResult"/>.
/// This interface allows you to specify actions to execute when a mocked method is called, while also supporting return value configuration.
/// </summary>
...
/// through method chaining on setup expressions for methods that return values.
/// </remarks>
[PublicAPI]
...
public interface ICallback<in TResult> : IFluent
{
    ...
    /// <returns>A <see cref="ICallbackResult{TResult}"/> that allows further configuration of the mock setup including return value specification.</returns>
